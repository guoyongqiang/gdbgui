...
class Expressions extends React.Component {
    ...
    render(){
        ...
        this.objs_to_delete = sorted_expression_objs.filter(obj => obj.in_scope === 'invalid')
        ...
        return (
        <div>
            <input id='expressions_input' className='form-control' placeholder='expression or variable'
                style={{'display': 'inline', 'padding': '6px 6px', height: '25px', 'fontSize': '1em', 'marginTop': '5px'}}
