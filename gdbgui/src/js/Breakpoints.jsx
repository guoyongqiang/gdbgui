...
class Breakpoint extends React.Component {
    render(){
        ...
        if(b.is_child_breakpoint){
            ...
            info_glyph = <span className='glyphicon glyphicon-th-list' title='Parent breakpoint with one or more child breakpoints. If parent or any child of this tree is deleted, all related breakpoints will be deleted.'></span>
        ...
        return  <div className='breakpoint' onClick={()=>SourceCode.view_file(b.fullname_to_display, b.line)}>
            <div>
                ...
                <tbody>
                    <tr>
                        <td>
                            <input type='checkbox' checked={checked} onChange={()=>Breakpoints.enable_or_disable_bkpt(checked, b.number)} />
